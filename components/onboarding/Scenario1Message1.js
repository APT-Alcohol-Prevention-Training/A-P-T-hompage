...
const Scenario1Message1 = () => {
  return (
    ...
    <p className="text-gray-700 mb-4">
      A standard drink contains <strong>0.6 ounces (14 g)</strong> of pure alcohol:
    </p>
    ...
    <div className="border-l-4 border-purple-500 bg-purple-50 p-4 rounded">
      <p className="text-gray-800 italic">
        ...
        contains less alcohol! Cocktails and mixed drinks often have more
        than one standard drink in them.
      </p>
    </div>
  </section>
  )
