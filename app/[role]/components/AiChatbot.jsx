...
const Sidebar = ({ showSidebar }) => {
  return (
    <div
      className={clsx(
        `absolute top-0 overflow-hidden left-0 bottom-0 translate-x-[-100%] lg:static lg:w-0 lg:max-w-0 transition-all duration-300 z-index-10 h-full flex flex-col justify-center items-center rounded-[16px] border-[1px] border-[#F0F2F5] box-shadow bg-[url('/sidebar-bg.png')] bg-cover bg-center`,
        showSidebar &&
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-[5px] max-w-[90%] mx-auto">
        <span className="text-[#023E6E99] text-center font-bold text-[12px] tracking-[4px] leading-[130%]">
          Get Started
        </span>
        <h1 className="text-[24px] text-[#023E6E] font-medium text-center leading-[120%] tracking-0">
          Hey there! I’m here for you
        </h1>
        <p className="text-[12px] font-medium text-[#023E6E99] text-center leading-[150%] tracking-0">
          A casual virtual assistant for daily help, small talk, reminders, and
          simple tasks.
        </p>
      </div>
    </div>
