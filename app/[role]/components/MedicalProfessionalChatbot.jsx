...
const Sidebar = () => {
  return (
    <div className="relative h-full w-[296px] flex flex-col justify-end items-center max-w-[296px] p-[17px] rounded-[16px] border-[1px] border-[#F0F2F5] box-shadow bg-[url('/medical-bg.png')] bg-cover bg-center">
      ...
      <div className="flex flex-col justify-center items-center gap-[5px] max-w-[90%] mx-auto">
        ...
        <div className="flex flex-col gap-[3px]">
          <span className="text-[#2D99E3] text-center font-bold text-[12px] tracking-[4px] leading-[130%]">
            Get Started
          </span>
          <h1 className="text-[24px] text-white font-medium text-center leading-[120%] tracking-0">
            Hello, how can I support your health today?
          </h1>
          <p className="text-[12px] font-medium text-white/70 text-center leading-[150%] tracking-0">
            Offers initial medical guidance, appointment booking, and health
            tips — not a replacement for real doctors.
          </p>
        </div>
      </div>
    </div>
